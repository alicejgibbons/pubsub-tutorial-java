...
### Run Java message subscriber with Dapr

1. Navigate to Java subscriber directory in your CLI:
...
```bash
dapr run --app-id java-subscriber --app-port 5002 mvn spring-boot:run
```
